...
export default function HeroSection() {
  return (
    <section className="lg:min-h-100/2 px-8 py-6 lg:py-10 text-center">
      ...
      <div className="mt-6 max-w-lg mx-auto text-[1rem] leading-[1.5rem] lg:text-[1.5rem] lg:leading-[2rem] tracking-[-.01em] font-medium bg-gradient-to-r from-[#3d77d3] to-[#9b59c4] bg-clip-text text-transparent">
