  ...
  return (
    <section className="min-h-100/2 py-10 lg:py-20">
      <CentralContainer variant="small">
        <div className="bg-[#171b26] rounded-[24px] text-center px-[24px] lg:px-[80px] py-[40px] lg:pt-[104px] lg:pb-[80px]">
          ...
          <div className="mt-10 flex justify-center">
            ...
            <div className="hidden xl:flex items-center justify-center p-5 h-16 w-16 justify-center rounded-full overflow-hidden bg-[#ffce67] transition-all duration-350 group hover:w-[344px] hover:bg-[#ffefc6]">
              ...
              <div className="ml-auto flex items-center shrink-0 justify-center transition-all duration-550 group-hover:rotate-60 rounded-full">
