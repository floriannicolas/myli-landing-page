...
export default function TeamSection() {
  ...
  const smallTeamScale = useTransform(
    scrollYProgress,
    [0, 1],
    [1.1, 1]
  );

  const bigImpackScale = useTransform(
    scrollYProgress,
    [0, 1],
    [0.9, 1]
  );
  ...
  return (
    <section ref={sectionRef} className="overflow-hidden mt-5 lg:mt-10 pt-23 lg:pt-50 pb-20 bg-linear-90 from-[#f1f7fd] to-[#fbf7fd] flex items-center justify-center">
      <CentralContainer>
