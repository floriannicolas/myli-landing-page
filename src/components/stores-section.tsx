          ...
          {stores1.map(({ image, label }) => (
            ...
            >
              ...
              <div className="absolute top-0 left-0 w-full h-full group">
                <div className="absolute inset-0 flex items-center justify-center px-3 bg-[#ffce67] rounded-3xl leading-5 transition-all translate-y-full group-always-hover:translate-y-0">
                  {label}
                </div>
              </div>
            </div>
